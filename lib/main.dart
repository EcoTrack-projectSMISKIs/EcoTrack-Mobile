...
import 'package:ecotrack_mobile/screens/about_page.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        //'/about': (context) => const ProtectedRoute(child: AboutPage()),
        '/device': (context) => ProtectedRoute(child: DeviceDetailsPage()),
