import 'package:ecotrack_mobile/screens/ai_recommendation.dart';
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  _buildDataRow(
                      "Consumption", "1.8 kWh", "Runtime", "5h 13m 41s"),
                  const SizedBox(height: 10),
            ...
            TextButton(
              onPressed: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        UsageHistoryPage(deviceName: 'Appliance'),
                  ),
                );
              },
              child: const Text(
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        AIRecommendationPage(deviceName: 'Appliance'),
                  ),
                );
              },
